...
export const CONSTRUCTOR_ORDER_SORT: 'CONSTRUCTOR_ORDER_SORT' = 'CONSTRUCTOR_ORDER_SORT';
...
export const deleteItem = (data: {_id: string; uniqueId: string}): IDeleteItem => ({
  type: DELETE_ITEM, 
  id: data._id, 
  index: data.uniqueId
});
...
export const constructorOrderSort = (items: object[]): IConstructorOrderSort => ({
...
export const getConstructorIngredientsRequest = (): IGetConstructorIngredientsRequest => ({
...
export const getConstructorIngredientsSuccess = (data: {data: object}): IGetConstructorIngredientsSuccess => ({
...
export const getConstructorIngredientsFailed = (): IGetConstructorIngredientsFailed => ({
